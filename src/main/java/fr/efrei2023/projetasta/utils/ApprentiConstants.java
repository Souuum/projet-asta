...
public class ApprentiConstants {
    ...
    public static final String FIND_ALL_APPRENTIS_NOT_ASSIGNED_TO_TUTEUR = "SELECT a FROM ApprentiEntity a WHERE a.tuteurEnseignant.idTuteurEnseignant IS NULL";
